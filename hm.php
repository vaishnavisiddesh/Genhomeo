...
<head>
    ...
    <title>Admin Panel - Manage Homeopathy Medicines</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Admin Panel - Manage Homeopathy Medicines</h2>

        <h3>Add New Homeopathy Medicine</h3>
        ...
        <div class="medicine-list">
            ...
            if (isset($_POST['action'])) {
                ...
                if ($action == 'add') {
                    if (isset($_POST['disease']) && !empty($_POST['disease']) && isset($_POST['medicine']) && !empty($_POST['medicine'])) {
                        ...
                        $sql = "INSERT INTO homeo_sugg (Disease, Medicine) VALUES (?, ?)";
                    ...
                    if (isset($_POST['disease_to_delete']) && !empty($_POST['disease_to_delete'])) {
                        ...
                        $sql = "DELETE FROM homeo_sugg WHERE Disease = ?";
                        $stmt = $conn->prepare($sql);
            ...
            $sql = "SELECT Disease, Medicine FROM homeo_sugg";
            ...
            if ($result) {
                if ($result->num_rows > 0) {
                    ...
                    echo "<p>No homeopathy medicines found in the database.</p>";
                }
                $result->free();
            } else {
